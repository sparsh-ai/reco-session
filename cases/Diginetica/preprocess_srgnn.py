...
dataset_base = './data'
dataset_branch = 'raw'
storage_branch = 'processed'

file_path = os.path.join(dataset_base, dataset_branch, dataset)
store_path = os.path.join(dataset_base, storage_branch, opt.dataset)
...
if opt.dataset == 'diginetica':
    ...
    pickle.dump(tra, open(os.path.join(store_path, 'train.txt'), 'wb'))
    pickle.dump(tes, open(os.path.join(store_path, 'test.txt'), 'wb'))
    pickle.dump(tra_seqs, open(os.path.join(store_path, 'all_train_seq.txt'), 'wb'))
elif opt.dataset == 'yoochoose':
